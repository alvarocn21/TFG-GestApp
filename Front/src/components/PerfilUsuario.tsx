...
const PerfilUsuario: FC<{
    ...
    return (
        <div className="h-screen md:pl-[220px]">
            {data &&
                <div className="mx-20 bg-white shadow-lg">
                    ...
                    <div className="px-6 py-4 flex flex-wrap mt-4">
                        <div className="w-1/2 mt-4">
                            <div className="font-bold text-xl">Nombre Completo</div>
                            <p className="text-gray-700 mt-4">{data.nombre + " " + data.apellido1 + " " + data.apellido2}</p>
                        </div>
                        <div className="w-1/2 mt-4">
