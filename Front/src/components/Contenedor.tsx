    ...
    <div>
      {token ? (
        <div className="bg-[url('./Fondo.jpg')] h-full bg-cover bg-no-repeat">
            ...
            <div className="flex h-full min-h-0 flex-col">
              <div className="scrollbar-trigger flex h-full w-full flex-1 items-start border-white/20">
                <nav className="flex h-full flex-1 flex-col space-y-1 p-2">
                  <button onClick={() => setPantallas(0)} className="flex py-3 px-3 items-center gap-3 rounded-md hover:bg-gray-500/10 transition-colors duration-200 text-white cursor-pointer text-base">
                  ...
                  <button onClick={() => setPantallas(5)} className="flex py-3 px-3 items-center gap-3 rounded-md hover:bg-gray-500/10 transition-colors duration-200 text-white cursor-pointer text-base">
                    <svg  height="1em" viewBox="0 0 448 512">
                      <style>{`svg{fill:#ffffff}`}</style>
                      <path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z" />
                    </svg>Perfil
                  </button>
                  <button onClick={() => setPantallas(2)} className="flex py-3 px-3 items-center gap-3 rounded-md hover:bg-gray-500/10 transition-colors duration-200 text-white cursor-pointer text-base">
                    <svg  height="1em" viewBox="0 0 384 512">
                      <style>{`svg{fill:#ffffff}`}</style>
                      <path d="M280 64h40c35.3 0 64 28.7 64 64V448c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V128C0 92.7 28.7 64 64 64h40 9.6C121 27.5 153.3 0 192 0s71 27.5 78.4 64H280zM64 112c-8.8 0-16 7.2-16 16V448c0 8.8 7.2 16 16 16H320c8.8 0 16-7.2 16-16V128c0-8.8-7.2-16-16-16H304v24c0 13.3-10.7 24-24 24H192 104c-13.3 0-24-10.7-24-24V112H64zm128-8a24 24 0 1 0 0-48 24 24 0 1 0 0 48z" />
                    </svg>Fichaje
                  </button>
                  <button onClick={() => setPantallas(3)} className="flex py-3 px-3 items-center gap-3 rounded-md hover:bg-gray-500/10 transition-colors duration-200 text-white cursor-pointer text-base">
                    <svg  height="1em" viewBox="0 0 512 512">
                      <style>{`svg{fill:#ffffff}`}</style>
                      <path d="M464 256A208 208 0 1 1 48 256a208 208 0 1 1 416 0zM0 256a256 256 0 1 0 512 0A256 256 0 1 0 0 256zM232 120V256c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2V120c0-13.3-10.7-24-24-24s-24 10.7-24 24z" />
                    </svg>Registro de tareas
                  </button>
                  <button onClick={() => setPantallas(4)} className="flex py-3 px-3 items-center gap-3 rounded-md hover:bg-gray-500/10 transition-colors duration-200 text-white cursor-pointer text-base">
                    <svg  height="1em" viewBox="0 0 448 512">
                      <style>{`svg{fill:#ffffff}`}</style>
                      <path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z" />
                    </svg>Documentos
                  </button>
                  <button onClick={() => setPantallas(1)} className="flex py-3 px-3 items-center gap-3 rounded-md hover:bg-gray-500/10 transition-colors duration-200 text-white cursor-pointer text-base">
                    <svg  height="1em" viewBox="0 0 576 512">
                      <style>{`svg{fill:#ffffff}`}</style>
                  ...
                  {data?.getUser.permisos === "Administrador" &&
                    <button onClick={() => setPantallas(6)} className="flex py-3 px-3 items-center gap-3 rounded-md hover:bg-gray-500/10 transition-colors duration-200 text-white cursor-pointer text-base">
                      <svg  height="1em" viewBox="0 0 448 512">
                        <style>{`svg{fill:#ffffff}`}</style>
                  ...
                  }} className="flex py-3 px-3 items-center gap-3 rounded-md hover:bg-gray-500/10 transition-colors duration-200 text-white cursor-pointer text-base">
          ...
          {pantallas === 0 &&
            <div>
              <div className="flex flex-col flex-1 md:pl-[190px]">
                ...
                <div className="flex items-center justify-between p-8 font-serif text-2xl">Bienvenido/a {data?.getUser.nombre}</div>
                <div className="flex items-center justify-between p-8 font-serif text-2xl"> GestApp contiene una serie de pantallas accesibles: <br /><br />  "Perfil" donde podras consultar todos tus datos personales y del empleado. <br />   "Fichaje" donde podras grabar y consultar todos tus fichajes del día.<br />   "Registro de horas" donde podras registrar y consultar todas tus tareas realizadas.<br />   "Documentos" donde podras consultar y descargar diferentes informes.<br />   "Calendario" donde podras guardar y consultas tus ausencias.</div>
              </div>
              <div className="flex flex-row mt-40 p-10 bg-neutral text-neutral-content md:pl-[190px]">
                <div className="mx-20">
          ...
          {pantallas === 2 && data &&
            <div>
              <div className="flex justify-center p-8 underline underline-offset-1 font-serif text-2xl">{fecha}</div>
